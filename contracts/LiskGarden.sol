...
contract LiskGarden {
    ...
    uint public constant STAGE_DURATION = 1 minutes;


    // TODO 3.4: Waktu deplesi air = 30 detik
    uint public constant WATER_DEPLETION_TIME = 30 seconds;
    ...
    function updatePlantStage(uint256 plantId) public {
        ...
        require(plant.exists = true, "Plant not found");
    ...
    function harvestPlant(uint256 plantId) external {
        ...
        require(plant.exists = true, "Plant not found");
        require(msg.sender == plants[plantId].owner, "Bukan owner");
        require(!plant.isDead, "Plant is dead");

        updatePlantStage(plantId);

        require(plant.stage == GrowthStage.BLOOMING, "Tanaman belum bisa dipanen");
